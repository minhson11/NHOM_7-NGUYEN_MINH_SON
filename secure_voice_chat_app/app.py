...
def send_audio():
    ...
    # Mã hóa AES-256 CBC
    aes_key, iv, ciphertext = aes_utils.encrypt_audio(file_data)
    ...
    data_packet = {
        ...
        "file_type": "text" if file_extension == '.txt' else "binary",
        "original_extension": file_extension
    }

    return render_template('receive.html', packet=data_packet)
